...
class Etl:
    ...
    def create_db_connection(self):
        ...
        try:
            ...
            self.conn1 = psycopg2.connect(host='localhost', port='5432', dbname='library', user='postgres', password='123456')
            self.conn2 = psycopg2.connect(host='localhost', port='5432', dbname='warehouse', user='postgres', password='123456')
            # create a cursor
